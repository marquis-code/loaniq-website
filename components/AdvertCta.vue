  ...
  <div class="relative isolate">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="mx-auto flex max-w-2xl flex-col gap-16 bg-white/5 px-6 py-16 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
        <img class="h-96 w-full flex-none rounded-2xl object-cover shadow-xl lg:aspect-square lg:h-auto lg:max-w-sm" src="@/assets/img/cta.jpg" alt="">
        <div class="w-full flex-auto">
          <h2 class="text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">Apply now and get up to 1 million naira in a few minutes</h2>
          <p class="mt-6 text-pretty text-lg/8 text-gray-300">Experience financial empowerment with Loan IQ Limited – effortlessly apply and secure a loan of up to 1 million naira in just minutes, ensuring swift access to the funds you need for your aspirations.</p>
          ...
          <div class="mt-10 flex">
            <a href="#" class="text-sm/6 font-semibold text-indigo-400">Get Started<span aria-hidden="true">&rarr;</span></a>
          </div>
        </div>
      </div>
    </div>
