...
<div class="mx-auto max-w-7xl px-6 lg:px-8">
  <div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
    <div class="mx-auto w-full max-w-xl lg:mx-0">
      <h2 data-aos="fade-up" class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Your trusted financial partner</h2>
      <p data-aos="fade-up" class="mt-6 text-lg/8 text-gray-600">Need financial support? We provide quick, hassle-free loan solutions tailored to your needs.</p>
