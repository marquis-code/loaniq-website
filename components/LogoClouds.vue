...
<div class="mx-auto max-w-7xl px-6 lg:px-8">
  <div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
    <div class="mx-auto w-full max-w-xl lg:mx-0">
      <h2 data-aos="fade-up" class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Your Trusted Partner for Easy and Fast Loans</h2>
      <p data-aos="fade-up" class="mt-6 text-lg/8 text-gray-600">Need financial support? We offer quick and hassle-free loan solutions tailored to your needs. Whether it's for personal use, business growth, or emergencies, we've got you covered.</p>
      <div data-aos="fade-up" class="mt-8 flex items-center gap-x-6">
        <a href="#" class="rounded-md bg-[#284d79] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#284d79]">Apply Now</a>
