<template>
        <header class="bg-white border-[0.5px] shadow-sm py-3 z-50 sticky top-0">
      <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="md:flex md:items-center md:gap-12">
            <NuxtLink class="block text-[#284d79]" to="/">
          ...
          <div class="flex items-center gap-4">
            <div class="sm:flex sm:gap-4">
             ...
             <div class="hidden sm:flex">
                <a class="rounded-md bg-[#284d79] px-5 py-2.5 text-sm font-medium text-white" href="#">
                  Get Started
                </a>
              </div>
            </div>
            ...
            <div class="block md:hidden">
              <button @click="isOpen = true" class="rounded-sm  text-gray-600 transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 9.5H3M21 4.5H3M21 14.5H3M17 19.5H3"/></svg>
              </button>
            </div>
          </div>
        </div>
    ...
    <div class="fixed inset-0 flex">
      ...
      <div class="relative mr-16 flex w-full max-w-xs flex-1">
        ...
        <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
          <button @click="isOpen = false" type="button" class="-m-2.5 px-2 py-3.5">
              ...
              <li>
                <ul role="list" class="-mx-2 space-y-1">
                  <li>
                    ...
                    <NuxtLink @click="isOpen = false" to="/" class="group flex gap-x-3 rounded-md bg-gray-800 px-2 py-3 text-sm/6 font-semibold text-white">
                  ...
                  <li>
                    <NuxtLink @click="isOpen = false" to="/about" class="group flex gap-x-3 rounded-md px-2 py-3 text-sm/6 font-semibold text-gray-400 hover:bg-gray-800 hover:text-white">
                      <svg class="size-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
