  ...
  <div class="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32 -mt-32">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="#" class="text-sm/6 text-gray-400 hover:text-white">Home </a>
              </li>
              <li>
                <a href="#" class="text-sm/6 text-gray-400 hover:text-white">About</a>
              </li>
              <li>
                <a href="#" class="text-sm/6 text-gray-400 hover:text-white">Loans</a>
              </li>
              <li>
                <a href="#" class="text-sm/6 text-gray-400 hover:text-white">Investments</a>
              </li>
              <li>
    ...
    <div class="mt-12 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
      <div class="flex gap-x-6 md:order-2">
        ...
        <a href="https://linkedin.com/in/loaniqltd" class="text-gray-400 hover:text-gray-300">
