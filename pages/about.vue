          ...
          >
            ...
            >
              <div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                >
                  At LoanIQ Limited, we are passionate about helping individuals
                  and businesses achieve their financial goals. With deep
                  expertise in the lending industry and a commitment to
                  exceptional customer service, we provide personalised
                  solutions that help our clients meet their unique financial
                  needs.
                </p>
              </div>
              <div
...
<section class="pb-32">
    ...
    <div class="mx-auto mt-20 max-w-7xl px-6 pb-16 lg:pb-0 lg:px-8">
          ...
          <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
            <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
              <p class="text-xl/8 text-gray-600">
                We are committed to providing our clients with personalised
                financial solutions that enhance their financial well-being, and
                at the same time building meaningful relationships with them.
              </p>
      ...
      <div class="bg-gray-900 py-24 sm:py-32 mt-32">
            ...
            >
              ...
              <div class="w-full flex-auto">
                ...
                <p class="mt-6 text-pretty text-lg/8 text-gray-300">
                  ...
                  the highest standards of trust, transparency, and
                  professionalism.
                </p>
                <ul
                  role="list"
                ...
                >
                  ...
                  <li class="flex gap-x-3">
                    ...
                    Maintaining the integrity and regulation of the financial
                    industry
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                  ...
                  <li class="flex gap-x-3">
                    ...
                    Providing personalised financial solutions tailored to
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          ...
          <p class="mt-6 text-lg/8 text-gray-600">
            ...
            exceptional financial services, ensuring integrity, and building
        ...
        >
          <div>
            <dt class="font-semibold text-gray-900">Trust</dt>
            <dd class="mt-1 text-gray-600">
              We are dedicated to building trusted relationships with our
              clients and maintaining the integrity of the financial industry.
            </dd>
          </div>
          <div>
            <dt class="font-semibold text-gray-900">Innovation</dt>
            <dd class="mt-1 text-gray-600">
              We strive to be innovative and stay ahead of the curve when it
              comes to financial strategies, products, and technologies.
            </dd>
          </div>
          <div>
            <dt class="font-semibold text-gray-900">Respect</dt>
            <dd class="mt-1 text-gray-600">
              We treat every client and employee with respect, and recognise
              that diversity and inclusion are fundamental to our success.
            </dd>
          </div>
          <div>
            <dt class="font-semibold text-gray-900">Professionalism</dt>
            <dd class="mt-1 text-gray-600">
              We conduct ourselves with the highest level of professionalism and
              ethical standards.
            </dd>
          </div>
          <div>
            <dt class="font-semibold text-gray-900">Transparency</dt>
            <dd class="mt-1 text-gray-600">
              We believe in being transparent and honest in our communications
              and transactions with clients.
            </dd>
          </div>
          <div>
            <dt class="font-semibold text-gray-900">Growth</dt>
            <dd class="mt-1 text-gray-600">
              We are committed to helping our clients grow their wealth and
              achieve their financial goals.
            </dd>
          </div>
          <div>
            <dt class="font-semibold text-gray-900">Responsibility</dt>
            <dd class="mt-1 text-gray-600">
              We take our responsibility to our clients seriously and are
      ...
      <!-- Team section -->
      <div class="mx-auto mt-32 max-w-7xl text-gray-700 px-6 sm:mt-40 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2
            class="text-pretty text-4xl font-semibold tracking-tight sm:text-5xl"
          >
            Our team
          </h2>
          <p class="mt-6 text-lg/8 text-gray-800">
        ...
        <li>
          ...
          <h3 class="mt-6 text-lg/8 font-semibold tracking-tight">Leslie Alexander</h3>
